...
### folder 'data'
In this folder, it has stored the data files for foundation model related analysis and microscopy images:
...
Note, in this repository, we have used the term 'similar' and 'dissimilar' as a shorthand for hydrocarbon and fluorocarbon amphiphiles. However, in the manuscript, we have opted to use the formal name, hydrocarbon and fluorocarbon, to elucidate its chemical structures.
